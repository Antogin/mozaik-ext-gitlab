...
class MergeRequestsGaugeGroup extends Component {
    constructor(props) {
        super(props);
...
MergeRequestsGaugeGroup.displayName = 'MergeRequestsGaugeGroup';

MergeRequestsGaugeGroup.propTypes = {
...
MergeRequestsGaugeGroup.defaultProps = {
    thresholds: [
...
reactMixin(MergeRequestsGaugeGroup.prototype, ListenerMixin);
reactMixin(MergeRequestsGaugeGroup.prototype, Mozaik.Mixin.ApiConsumer);


export default MergeRequestsGaugeGroup;
